...
public class Robot extends IterativeRobot {
    ...
    public static SendableChooser autoModes;
    CameraServer server;
    /**
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        autoModes.addDefault("Default", new AutonomousCommand());
        autoModes.addObject("Dirve Forward", new DriveFor());
        autoModes.addObject("Drive Backwards", new DriveBack());
    ...
    public void autonomousInit() {
    	...
    	autoModes = (SendableChooser) autoModes.getSelected();
